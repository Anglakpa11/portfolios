  ...
  return (
    <Section id="stack" className="bg-black text-white px-[40px] pt-0 pb-32">
      ...
      <div className="sticky top-0 z-20 bg-black pt-16 md:pt-24 pb-12">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12">
          <div className="max-w-[800px]">
            <h2 className="text-[12.5vw] md:text-[8vw] lg:text-[120px] font-black uppercase leading-[0.8] tracking-[-0.04em] mb-12">
              FAVOURITE STACK
            </h2>
          ...
          <div className="flex items-center gap-4 group">
            ...
            <div className="bg-[#6C3BFF] h-[36px] px-6 flex items-center justify-center rounded-full text-[12px] md:text-[14px] font-black tracking-[0.1em] uppercase text-white shadow-[0_0_20px_rgba(108,59,255,0.3)]">
              MY SKILL
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        {/* Right side (content) */}
        <div className="flex-1 flex flex-col gap-16 md:gap-20 pt-12">
          {PORTFOLIO_DATA.stack.map((item, index) => (
            <motion.div 
              key={index} 
              className="group flex flex-col md:flex-row gap-8 md:gap-16 pt-8 border-t border-white/5 first:border-0"
              initial="initial"
              whileInView="animate"
              whileHover="hover"
              viewport={{ once: true }}
            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-4">
                ...
                {/* Description Area */}
                <p className="text-[14px] md:text-[18px] leading-relaxed text-white/70 max-w-[900px] group-hover:text-white transition-colors duration-300">
                  {item.desc}
                </p>
              </div>
            </motion.div>
