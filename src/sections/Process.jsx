      ...
      <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
        ...
        <div className="w-full lg:w-[45%] sticky top-24 hidden lg:block">
           <div className="aspect-[4/5] rounded-[12px] overflow-hidden bg-[#111111] border border-white/10">
              <img 
                src="file:///C:/Users/angla/.gemini/antigravity/brain/3ff49f72-d006-4bdd-9f05-fb1672af1fd7/workspace_laptop_cinematic_1774714050626.png" 
                alt="Workspace" 
        ...
        <div className="w-full lg:w-[55%] flex flex-col gap-20">
           {PORTFOLIO_DATA.process.map((step, idx) => (
             ...
             >
               ...
               <p className="text-[16px] md:text-[20px] leading-relaxed text-[#FFFFFF90] font-medium mb-8">
                 {step.description}
               </p>
