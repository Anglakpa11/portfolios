...
export default function Motivation() {
  ...
  return (
    <Section id="motivation" className="bg-black text-white px-[40px] pt-0 pb-32">
      {/* Full Screen Image */}
      <div 
        ref={containerRef}
        className="w-[calc(100%+80px)] -mx-[40px] h-[100vh] md:h-screen mb-[120px] overflow-hidden relative"
      >
      ...
      <div className="relative">
        ...
        <div className="z-20 bg-black pt-12 md:pt-[60px] pb-12">
        ...
        <div className="flex flex-col lg:flex-row border-t border-white/10 lg:border-t-0">
          ...
          <div className="flex-1 flex flex-col gap-10 lg:gap-12 pt-12">

            <div className="flex flex-col gap-8 text-[20px] md:text-[24px] lg:text-[28px] font-medium leading-[1.6] text-white/90 max-w-[900px]">
              <p>
            ...
            <div className="flex flex-col gap-6 mt-8 lg:mt-12 pt-12 border-t border-white/5">
              <h3 className="text-[20px] md:text-[28px] lg:text-[32px] font-bold uppercase leading-[1.3] tracking-tight text-white max-w-[800px]">
                "DESIGN IS NOT JUST WHAT IT LOOKS LIKE AND FEELS LIKE. DESIGN IS HOW IT WORKS."
              </h3>
              <div className="flex justify-start pt-2">
                <p className="text-[16px] md:text-[18px] lg:text-[20px] font-bold uppercase tracking-widest text-[#6C3BFF]">
                  — STEVE JOBS.
                </p>
              </div>
            </div>
