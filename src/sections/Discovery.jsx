    ...
    <Section id="process" className="p-0 border-t border-white/10">
      <div ref={containerRef} className="h-[400vh] md:h-[500vh] relative w-full bg-black">
        ...
        <div className="sticky top-0 h-screen w-full flex flex-col overflow-hidden">
          ...
          <div className="flex flex-col items-center text-center pt-8 md:pt-12 pb-2 md:pb-4 z-30 px-[24px]">
            <motion.h2
              initial={{ opacity: 0, y: 40 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: "-100px" }}
              transition={{ duration: 0.8, ease: "easeOut", delay: 0 }}
              className="text-[clamp(40px,10vw,64px)] md:text-[7vw] lg:text-[120px] font-bold uppercase leading-[0.8] tracking-[-0.04em] text-[#FFFFFF] mb-4 md:mb-6"
            >
            ...
            <motion.span
              ...
              className="text-[10px] md:text-[14px] font-bold tracking-[0.3em] uppercase text-[#FFFFFF] mb-8 md:mb-12"
            >
              ...
              {PORTFOLIO_DATA.process.map((step, idx) => (
                ...
                >
                  <div className="w-full h-full flex flex-col lg:flex-row items-stretch bg-[#0A0A0A] lg:bg-transparent rounded-xl overflow-hidden border border-white/5 lg:border-0">
                    ...
                    <div className="flex-[1] flex flex-col justify-center px-6 md:px-[5vw] lg:px-[8vw] py-8 md:py-12 order-2 lg:order-1">
                      <div className="flex items-start gap-4 md:gap-8 mb-4 md:mb-8">
                        <span className="text-[16px] md:text-[24px] font-bold font-mono text-[#FFFFFF40] shrink-0 mt-1 md:mt-2">
                          [ {step.id} ]
                        </span>
                        <h3 className="text-[28px] md:text-[50px] lg:text-[60px] font-black uppercase tracking-tighter text-[#FFFFFF] leading-[1]">
                          {step.title}
                        </h3>
                      </div>

                      <p className="text-[15px] md:text-[22px] leading-relaxed text-[#FFFFFF90] font-medium mb-6 md:mb-8 max-w-[600px]">
                        {step.description}
                      </p>
                      ...
                      <ul className="flex flex-col gap-3 md:gap-5">
                        {step.details?.map((detail, i) => (
                          <li key={i} className="flex items-start gap-3 md:gap-4 text-[14px] md:text-[20px] text-[#FFFFFF]">
                            <span className="mt-[8px] md:mt-[12px] w-1.5 h-1.5 md:w-2 md:h-2 bg-white/40 shrink-0" />
                    ...
                    <div className="flex-1 w-full relative h-[25vh] lg:h-auto order-1 lg:order-2">
                      <motion.div
          ...
          <div className="absolute bottom-[24px] md:bottom-[40px] left-[24px] md:left-[40px] right-[24px] md:right-[40px] flex justify-between items-center z-30">
